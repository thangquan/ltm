...
public class EditProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String productsoluongcon = request.getParameter("soluongcon");
            String productImage = request.getParameter("image");
            String productPrice = request.getParameter("price");
            DAO dao = new DAO();
            dao.EditProduct(productId,productName, productSize, productCategory, productImage, productColor,productsoluongcon, productPrice);
